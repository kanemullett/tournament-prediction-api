...
public class LeagueTemplateController {
    ...
    @PostMapping
    public List<LeagueTemplate> createLeagueTemplates(@RequestBody List<LeagueTemplate> leagueTemplates) {
        return leagueTemplateService.createLeagueTemplates(leagueTemplates);
    }

    @GetMapping("/{leagueTemplateId}")
    public LeagueTemplate getLeagueTemplateById(@PathVariable String leagueTemplateId) {
        return leagueTemplateService.getLeagueTemplateById(leagueTemplateId);
    }

    @DeleteMapping("/{leagueTemplateId}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void deleteLeagueTemplateById(@PathVariable String leagueTemplateId) {
