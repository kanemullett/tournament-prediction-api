...
class TestDatabaseQueryService:
    ...
    __database_query_service: DatabaseQueryService = DatabaseQueryService(
        __connection,
        __query_builder,
        __record_builder
    )
    ...
    def test_should_build_and_send_select_query(self):
        ...
        query: str = ("SELECT id, column1, column2 FROM "
                      "test_schema.test_table WHERE column1 < 23 AND column2 "
                      "= 'hello' ;")
        ...
        query_response: QueryResponse = (
            self.__database_query_service.retrieve_records(query_request)
        )
        ...
        captured_args_query_build, captured_kwargs = (
            self.__query_builder.apply.call_args
        )
        Assertions.assert_equals(
            SqlOperator.SELECT,
            captured_args_query_build[0].operator
        )

        captured_args_record, captured_kwargs = (
            self.__record_builder.apply.call_args
        )
        Assertions.assert_equals(
            ["id", "column1", "column2"],
            captured_args_record[0]
        )
    ...
    def test_should_build_and_send_insert_query(self):
        ...
        query: str = ("INSERT INTO test_schema.test_table (column1, column2, "
                      "column3, column4, column5) VALUES ('value1', 2, "
                      "'value3', NULL, NULL), (NULL, NULL, 'value3', 4, "
                      "'value5') ;")
        self.__query_builder.apply.return_value = query
        ...
        Assertions.assert_equals(
            ...
            captured_args_query_build[0].table
        )
        Assertions.assert_equals(
            update_request.records,
            captured_args_query_build[0].records
        )
    ...
    def test_should_build_and_send_update_query(self):
        ...
        query: str = ("UPDATE test_schema.test_table SET column1 = CASE WHEN "
                      "id = 'id1' THEN 'value1' ELSE column1 END WHERE id IN "
                      "('id1') ;")
        self.__query_builder.apply.return_value = query
    ...
    def test_should_build_and_send_delete_query(self):
        ...
        query: str = ("DELETE FROM test_schema.test_table WHERE column1 < 23 "
                      "AND column2 = 'hello';")
        self.__query_builder.apply.return_value = query
