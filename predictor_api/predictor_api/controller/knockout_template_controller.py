...
class KnockoutTemplateController:
    """
    Controller containing endpoints to perform knockout template-related
    actions.

    Attributes:
        __service (KnockoutTemplateService): The knockout template service
            containing knockout template-based logic.
    """

    def __init__(
            self,
            knockout_template_service: KnockoutTemplateService) -> None:
        """
            ...
            responses={
                404: {
                    ...
                    "content": {
                        "application/json": {
                            "example": {
                                "detail": "No knockout templates found with a "
                                          "matching id."
                            }
                        }
                    }
            ...
            responses={
                ...
                409: {
                    ...
                    "content": {
                        "application/json": {
                            "example": {
                                "detail": "Cannot delete knockout template as "
    ...
    async def get_knockout_templates(self) -> list[KnockoutTemplate]:
        ...
        """
        return self.__service.get_knockout_templates()

    async def create_knockout_templates(
            self,
        ...
        """
        return self.__service.create_knockout_templates(knockout_templates)

    async def get_knockout_template_by_id(
            self,
            knockout_template_id: UUID) -> KnockoutTemplate:
        """
        GET /knockout-templates/{knockout_template_id} endpoint to retrieve a
        single stored knockout template by its id.
        ...
        """
        return self.__service.get_knockout_template_by_id(knockout_template_id)

    async def delete_knockout_template_by_id(
            self,
            knockout_template_id: UUID) -> Response:
        """
        DELETE /knockout-templates/{knockout_template_id} endpoint to delete
        a single stored knockout template by its id.

        Args:
            knockout_template_id (UUID): The id of the knockout template to
                delete.
        """
        self.__service.delete_knockout_template_by_id(knockout_template_id)
