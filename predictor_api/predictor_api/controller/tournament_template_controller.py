...
class TournamentTemplateController:
    """
    Controller containing endpoints to perform tournament template-related actions.

    Attributes:
        __tournament_template_service (TournamentTemplateService): The tournament template service containing tournament
    ...
    def __init__(self, tournament_template_service: TournamentTemplateService) -> None:
        ...
        Attributes:
            tournament_template_service (TournamentTemplateService): The tournament template service containing
                tournament template-based logic.
        """
        ...
        self.router.add_api_route(
            ...
            responses={
                404: {
                    "description": "Not Found - No tournament templates found with a matching id.",
                    "content": {
                        "application/json": {
                            "example": {
        ...
        self.router.add_api_route(
            ...
            responses={
                204: {
                    "description": "No Content - The tournament template was successfully deleted."
                },
                409: {
                    "description": "Conflict - Cannot delete tournament template as it is part of an existing "
                                   "tournament.",
                    "content": {
                        "application/json": {
                            "example": {
