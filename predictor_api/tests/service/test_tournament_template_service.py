...
class TestTournamentTemplateService:
    ...
    __tournament_template_service: TournamentTemplateService = TournamentTemplateService(__database_query_service)
    ...
    def test_should_return_tournament_templates_with_child_templates(self):
        ...
        # When
        tournament_templates: list[TournamentTemplate] = self.__tournament_template_service.get_tournament_templates()
        ...
        Assertions.assert_equals(ConditionOperator.EQUAL, join1_condition.operator)

        join1_column: Column = join1_condition.column
        Assertions.assert_equals(["tourn", "leagueTemplateId"], join1_column.parts)
        ...
        Assertions.assert_equals(ConditionOperator.EQUAL, join2_condition.operator)

        join2_column: Column = join2_condition.column
        Assertions.assert_equals(["tourn", "knockoutTemplateId"], join2_column.parts)
    ...
    def test_should_create_tournament_templates(self):
        ...
        # When
        created: list[TournamentTemplate] = self.__tournament_template_service.create_tournament_templates(templates)
        ...
        Assertions.assert_equals(UUID("80e9c164-637d-400f-a3cf-bf922073bc9b"), record1["knockoutTemplateId"])
        ...
        Assertions.assert_equals(UUID("0ca3adf1-f5a5-43e9-9c82-5619340739be"), record2["leagueTemplateId"])
        ...
        Assertions.assert_equals(UUID("508c8b55-2e0c-415b-8078-2dcb2065c7ca"), record3["leagueTemplateId"])
        Assertions.assert_equals(UUID("1a4d1cc8-f035-439a-b274-fe739b8fcfa5"), record3["knockoutTemplateId"])
    ...
    def test_should_return_tournament_template_by_id(self):
        ...
        # When
        tournament_template: TournamentTemplate = self.__tournament_template_service.get_tournament_template_by_id(
        ...
        Assertions.assert_equals(UUID("d15956ef-d199-40b1-b7d7-850a9add97e7"), condition.value)
    ...
    def test_should_raise_exception_if_tournament_template_not_found(self):
        ...
        with raises(HTTPException) as httpe:
            self.__tournament_template_service.get_tournament_template_by_id(
    ...
    def test_should_delete_tournament_template_by_id(self):
        ...
        # When
        self.__tournament_template_service.delete_tournament_template_by_id(
            UUID("c08fd796-7fea-40d9-9a0a-cb3a49cce2e4")
        )
    ...
    def test_should_not_delete_tournament_template_if_used_by_tournament_template(self):
        # Given
        self.__database_query_service.retrieve_records.return_value = QueryResponse(
            referenceId="90a6637a-e534-46bd-8715-33c6f2afdd7a",
            recordCount=1,
