...
class TestGroupService:
    ...
    def test_should_assign_teams_to_group(self):
        # Given
        team_ids: list[UUID] = [
            UUID("525bf855-a5b1-45cf-a1de-c017e67c0ce7"),
            UUID("bc339fee-cfda-4dbd-b1de-337a270bc414")
        ...
        # When
        group: Group = self.__service.add_teams_to_group(
            UUID("5341cff8-df9f-4068-8a42-4b4288ecba87"),
            UUID("96074478-23c4-4b6f-a8a4-1abe9fac2659"),
            team_ids
        )
        ...
        team_check_args, team_check_kwargs = (
            self.__query_service.retrieve_records.call_args_list
        )[2]
        Assertions.assert_type(QueryRequest, team_check_args[0])

        team_check_request: QueryRequest = team_check_args[0]

        team_check_table: Table = team_check_request.table
        Assertions.assert_equals("predictor", team_check_table.schema_)
        Assertions.assert_equals("teams", team_check_table.table)

        Assertions.assert_equals(
            1,
            len(team_check_request.conditionGroup.conditions)
        )

        team_check_condition: QueryCondition = (
            team_check_request.conditionGroup.conditions
        )[0]
        Assertions.assert_equals(["id"], team_check_condition.column.parts)
        Assertions.assert_equals(
            ConditionOperator.IN,
            team_check_condition.operator
        )
        Assertions.assert_equals(
            [
                UUID("525bf855-a5b1-45cf-a1de-c017e67c0ce7"),
            ...
            team_check_condition.value
        )

        group_team_args, group_team_kwargs = (
            self.__query_service.retrieve_records.call_args_list
        )[3]
        Assertions.assert_type(QueryRequest, group_team_args[0])

        group_team_request: QueryRequest = group_team_args[0]

        group_team_table: Table = group_team_request.table
        Assertions.assert_equals("predictor", group_team_table.schema_)
        Assertions.assert_equals(
            "group-teams_5341cff8-df9f-4068-8a42-4b4288ecba87",
            group_team_table.table
        )

        Assertions.assert_equals(
            1,
            len(group_team_request.conditionGroup.conditions)
        )

        group_team_condition: QueryCondition = (
            group_team_request.conditionGroup.conditions
        )[0]
        Assertions.assert_equals(
            ["groupId"],
            group_team_condition.column.parts
        )
        Assertions.assert_equals(
            ConditionOperator.EQUAL,
            group_team_condition.operator
        )
        Assertions.assert_equals(
            UUID("96074478-23c4-4b6f-a8a4-1abe9fac2659"),
            group_team_condition.value
        )

        team_count_args, team_count_kwargs = (
            self.__query_service.retrieve_records.call_args_list
        )[4]
        Assertions.assert_type(QueryRequest, team_count_args[0])

        team_count_request: QueryRequest = team_count_args[0]

        team_count_table: Table = team_count_request.table
        Assertions.assert_equals("predictor", team_count_table.schema_)
        ...
        team_count_join1_table: Table = team_count_join1.table
        Assertions.assert_equals("predictor", team_count_join1_table.schema_)
        Assertions.assert_equals(
            "tournament-templates",
            team_count_join1_table.table
        )
        Assertions.assert_equals("temp", team_count_join1_table.alias)

        team_count_join1_condition: QueryCondition = (
            team_count_join1.joinCondition
        )
        Assertions.assert_equals(
            ["tourn", "templateId"],
            team_count_join1_condition.column.parts
        )
        Assertions.assert_equals(
            ConditionOperator.EQUAL,
            team_count_join1_condition.operator
        )
        Assertions.assert_equals(
            ["temp", "id"],
        ...
        team_count_join2_table: Table = team_count_join2.table
        Assertions.assert_equals("predictor", team_count_join2_table.schema_)
        Assertions.assert_equals(
            "league-templates",
            team_count_join2_table.table
        )
        Assertions.assert_equals("league", team_count_join2_table.alias)

        team_count_join2_condition: QueryCondition = (
            team_count_join2.joinCondition
        )
        Assertions.assert_equals(
            ["temp", "leagueTemplateId"],
            team_count_join2_condition.column.parts
        )
        Assertions.assert_equals(
            ConditionOperator.EQUAL,
            team_count_join2_condition.operator
        )
        Assertions.assert_equals(
            ["league", "id"],
            team_count_join2_condition.value.parts
        )

        Assertions.assert_equals(
            1,
            len(team_count_request.conditionGroup.conditions)
        )

        team_count_condition: QueryCondition = (
            team_count_request.conditionGroup.conditions
        )[0]
        Assertions.assert_equals(
            ["tourn", "id"],
            team_count_condition.column.parts
        )
        Assertions.assert_equals(
            ConditionOperator.EQUAL,
            team_count_condition.operator
        )
        Assertions.assert_equals(
            UUID("5341cff8-df9f-4068-8a42-4b4288ecba87"),
            team_count_condition.value
        )
    ...
    def test_should_error_teams_not_found(self):
        # Given
        team_ids: list[UUID] = [
            UUID("525bf855-a5b1-45cf-a1de-c017e67c0ce7"),
            UUID("bc339fee-cfda-4dbd-b1de-337a270bc414")
        ...
        # When
        with raises(HTTPException) as httpe:
            self.__service.add_teams_to_group(
                UUID("5341cff8-df9f-4068-8a42-4b4288ecba87"),
                UUID("96074478-23c4-4b6f-a8a4-1abe9fac2659"),
                team_ids
            )
        ...
        Assertions.assert_equals(
            "No teams found with ids: ["
            "'525bf855-a5b1-45cf-a1de-c017e67c0ce7', "
            "'bc339fee-cfda-4dbd-b1de-337a270bc414']",
            httpe.value.detail
        )

    def test_should_error_tournament_not_found_assign_teams(self):
        # Given
        team_ids: list[UUID] = [
            UUID("525bf855-a5b1-45cf-a1de-c017e67c0ce7"),
            UUID("bc339fee-cfda-4dbd-b1de-337a270bc414")
    ...
    def test_should_error_tournament_no_group_stage_assign_teams(self):
        # Given
        team_ids: list[UUID] = [
            UUID("525bf855-a5b1-45cf-a1de-c017e67c0ce7"),
            UUID("bc339fee-cfda-4dbd-b1de-337a270bc414")
    ...
    def test_should_error_group_not_found_assign_teams(self):
        # Given
        team_ids: list[UUID] = [
            UUID("525bf855-a5b1-45cf-a1de-c017e67c0ce7"),
            UUID("bc339fee-cfda-4dbd-b1de-337a270bc414")
    ...
    def test_should_error_too_many_teams(self):
        # Given
        team_ids: list[UUID] = [
            UUID("525bf855-a5b1-45cf-a1de-c017e67c0ce7"),
            UUID("bc339fee-cfda-4dbd-b1de-337a270bc414")
        ...
        self.__query_service.retrieve_records.side_effect = [
            ...
            QueryResponse(
                ...
                records=[
                    {
                        "groupId": "96074478-23c4-4b6f-a8a4-1abe9fac2659",
                        "teamId": "6c1496f5-b819-4ed3-b4c3-17bdaa6f252d"
                    },
                    {
                        "groupId": "96074478-23c4-4b6f-a8a4-1abe9fac2659",
                        "teamId": "ead4e0fa-8efa-49b5-a980-0a67c28b5c4d"
                    },
                    {
                        "groupId": "96074478-23c4-4b6f-a8a4-1abe9fac2659",
                        "teamId": "1708fce1-2862-4604-b863-5fb4f00b68d2"
                    }
                ]
            ),
            QueryResponse(
        ...
        Assertions.assert_equals(
            "The number of groups in this tournament's group stage has been "
            "exceeded.",
            httpe.value.detail
        )

    def test_should_remove_team_from_group(self):
        # Given
        self.__query_service.retrieve_records.side_effect = [
            QueryResponse(
                referenceId=UUID("ac97eb18-d9b7-40b8-b406-14f90455121a"),
        ...
        # When
        group: Group = self.__service.remove_team_from_group(
            UUID("5341cff8-df9f-4068-8a42-4b4288ecba87"),
            UUID("96074478-23c4-4b6f-a8a4-1abe9fac2659"),
            UUID("6c1496f5-b819-4ed3-b4c3-17bdaa6f252d")
        )
        ...
        update_condition1: QueryCondition = (
            update_request.conditionGroup.conditions
        )[0]
        Assertions.assert_equals(["groupId"], update_condition1.column.parts)
        Assertions.assert_equals(
            ConditionOperator.EQUAL,
            update_condition1.operator
        )
        Assertions.assert_equals(
            UUID("96074478-23c4-4b6f-a8a4-1abe9fac2659"),
            update_condition1.value
        )

        update_condition2: QueryCondition = (
            update_request.conditionGroup.conditions
        )[1]
        Assertions.assert_equals(["teamId"], update_condition2.column.parts)
        Assertions.assert_equals(
            ConditionOperator.EQUAL,
            update_condition2.operator
        )
        Assertions.assert_equals(
            UUID("6c1496f5-b819-4ed3-b4c3-17bdaa6f252d"),
            update_condition2.value
        )
    ...
    def test_should_error_tournament_not_found_remove_team(self):
        # Given
        self.__tournament_service.get_tournament_by_id.side_effect = (
            HTTPException(
                status_code=404,
        ...
        # When
        with raises(HTTPException) as httpe:
            self.__service.remove_team_from_group(
                UUID("5341cff8-df9f-4068-8a42-4b4288ecba87"),
                UUID("96074478-23c4-4b6f-a8a4-1abe9fac2659"),
                UUID("6c1496f5-b819-4ed3-b4c3-17bdaa6f252d")
            )
    ...
    def test_should_error_tournament_no_group_stage_remove_team(self):
        # Given
        self.__query_service.retrieve_records.side_effect = [
            QueryResponse(
                referenceId=UUID("ac97eb18-d9b7-40b8-b406-14f90455121a"),
    ...
    def test_should_error_group_not_found_remove_team(self):
        # Given
        self.__query_service.retrieve_records.side_effect = [
            QueryResponse(
                referenceId=UUID("ac97eb18-d9b7-40b8-b406-14f90455121a"),
